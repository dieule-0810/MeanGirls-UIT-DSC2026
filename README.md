...
|---|---|
| Số văn bản trong `corpus_clean.jsonl` | `8507` |
| SHA-256 của `corpus_clean.jsonl` | `365306b58c0c14e87adce81a2b383a2245002faacb41b95928ddff4db0d73945` |
| Số chunk trong `chunks.jsonl` | `524422` |
